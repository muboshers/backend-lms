...
const createTeachingCenterAdminController = async (req, res) => {
    try {
        // #swagger.tags = ['Teaching Center']
        // #swagger.summary = "Create a teaching center"
        /* #swagger.security = [{
            "apiKeyAuth": []
        }] */
...
const updateTeachingCenterAdminController = async (req, res) => {
    try {
        // #swagger.tags = ['Teaching Center']
        // #swagger.summary = "Update admin a teaching center"
        /* #swagger.security = [{
            "apiKeyAuth": []
        }] */
...
const deleteTeachingCenterAdminController = async (req, res) => {
    try {
        // #swagger.tags = ['Teaching Center']
        // #swagger.summary = "Delete admin a teaching center"
...
const teachingCenterUpdateController = async (req, res) => {
    try {
        // #swagger.tags = ['Teaching Center']
        // #swagger.summary = "Update a teaching center"
        /* #swagger.security = [{
                    "apiKeyAuth": []
                }] */
        let bot;
...
const UpdateTeachingCenterTgBotController = async (req, res) => {
    try {
        // #swagger.tags = ['Teaching Center']
        // #swagger.summary = "Update TG BOT teaching center"
        /* #swagger.security = [{
                    "apiKeyAuth": []
                }] */
...
const getTeachingCenterAdminController = async (req, res) => {
    try {
        // #swagger.tags = ['Teaching Center']
        // #swagger.summary = "Get teaching center list for admin"
        /* #swagger.security = [{
            "apiKeyAuth": []
        }] */
...
const GetByIdOrMeTeachingCenterController = async (req, res) => {
    try {
        // #swagger.tags = ['Teaching Center']
        // #swagger.summary = "Get teaching center by id or get me teaching center list for admin"
        /* #swagger.security = [{
            "apiKeyAuth": []
        }] */
